...
Think of Executable as a *COM*, a Command-line Object Mapper,
...
than Ruby's own own standard syntax. No special DSL is required. 
...
(those ending in '=') correspond to an options and a query method (those
...
For example, here is a simple "Hello, World!" commandline tool.
    ...
    class HelloCommand < Executable::Command
      # Say it in uppercase?
      def load=(bool)
        @loud = bool
      end
