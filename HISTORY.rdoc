...
that we had been working on, called Executioner and briefly CLI::Base, was
ported over and with some API changes is now the new Executable project.
The idea of the project is generally the same, but Executable now offers
more features, such a good help output and and namespace-based subcomamnds.
